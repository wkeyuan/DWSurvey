...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_mouseDrag: function(event, noPropagation) {
    	...
    	//this.helper[0].style.left = 10 + 'px';
    	//this.helper[0].style.top = 20 + 'px';
		/*
    	...
    	if(scrollTop>=287){
    		this.helper[0].style.left = (clientX-200) + 'px';
    	}else{
    		this.helper[0].style.left = clientX + 'px';
    	}
    	//this.helper[0].style.left = clientX + 'px';
    	this.helper[0].style.top = (clientY) + 'px';
    	console.debug("keydrag111");*/
    	//处理链接结束的地方
		return false;
	},
...
$.ui.plugin.add("draggable", "scroll", {
	...
	drag: function(event, ui) {
		...
		console.debug("keydrag222fffffScroll");
	}
});
