...
<div id="header_right">
<div style="line-height: 22px;"><a href="${ctx }/design/my-survey/list.do">问卷</a>&nbsp;&nbsp;<a href="${ctx }/ic/user/myaccount.do">账号</a></div>
</div>
</div>
...
<div class="tools_tabs">
	...
	<div class="tools_tabs_right"><ul><li style="padding: 0px;font-size: 12px;line-height: 22px;"><a href="http://www.diaowen.net/buy2.jsp" target="_black" style="text-decoration: none;color: gray;">升级到企业版</a></li></ul></div>
</div>
...
<div class="tools_contents">
								...
								<div class="surveyQuItemContent">
									...
									<div class="quCoItem"><ul>
										<li class="quCoItemUlLi">
											...
											<input type='text' class='optionInpText'  style="display: none;"/>
									...
									<div class="quCoItem"><ul>
										<li class="quCoItemUlLi">
											...
											<div class="quFillblankItem">
												<input type="text" style="width:200px;padding:5px;border:1px solid #d0cfcf;" class="quFillblankAnswerInput" />
	...
	<div id="toolsChenQu_1" class="tools_item">
			<div class="toolbars">
				<ul class="dragQuUl">
	...
	<div id="toolsEvent" class="tools_item">
		<div class="toolbars">
			...
			<li id="surveyAttrSetToolbar"  class="surveyAttrSetToolbar_li">
				<a href="${ctx }/design/my-survey-design/previewDev.do?surveyId=${param['surveyId']}" >
												...
												<td width="${600/en.cellCount }">
													...
													<c:choose>
														<c:when test="${quOptionIndex < fn:length(en.quRadios) }">
																...
																<input type='text' class='optionInpText'  style="${en.quRadios[quOptionIndex].isNote eq 1 ? '':'display: none;'}"/>
																<div class="quItemInputCase">
																	<input type="hidden" name="quItemId" value="${en.quRadios[quOptionIndex].id }"><input type="hidden" name="quItemSaveTag" value="1">
																	<input type="hidden" name="isNote" value="${en.quRadios[quOptionIndex].isNote }">
																	<input type="hidden" name="checkType" value="${en.quRadios[quOptionIndex].checkType }">
																	<input type="hidden" name="isRequiredFill" value="${en.quRadios[quOptionIndex].isRequiredFill }">
																</div>
														</c:when>
												...
												<td width="${600/en.cellCount }">
													...
													<c:choose>
														<c:when test="${quOptionIndex < fn:length(en.quCheckboxs) }">
																...
																<input type='text' class='optionInpText'  style="${en.quCheckboxs[quOptionIndex].isNote eq 1 ? '':'display: none;'}"/>
																<div class="quItemInputCase">
																	<input type="hidden" name="quItemId" value="${en.quCheckboxs[quOptionIndex].id }"><input type="hidden" name="quItemSaveTag" value="1">
																	<input type="hidden" name="isNote" value="${en.quCheckboxs[quOptionIndex].isNote }">
																	<input type="hidden" name="checkType" value="${en.quCheckboxs[quOptionIndex].checkType }">
																	<input type="hidden" name="isRequiredFill" value="${en.quCheckboxs[quOptionIndex].isRequiredFill }">
																</div>
														</c:when>
														<c:otherwise><div class="emptyTd"></div></c:otherwise>
													</c:choose>
					...
					<c:when test="${en.quType eq 'FILLBLANK' }">
						<div class="surveyQuItemBody">
							...
							<div class="quInputCase" style="display: none;">
								...
								<input type="hidden" name="paramStr01" value="${en.paramStr01 }">
								<input type="hidden" name="paramInt01" value="${en.paramInt01}">
		...
		<div class="dwCommonDialogContent">
			...
			<div class="dwQuSetCon dwQuFormSetDialog dwQuDialogCon" >
				<ul>
					...
					<li class="contactsFieldLi" style="display: none;" ><label>用户填写的内容，会成为联系人的</label>
...
<div id="modelUIDialog">
	...
	<div class="dwQuRadioCheckboxOption dwQuFormSetDialog dwQuDialogCon" >
				<ul>
					...
					<li class="quOptionFillContentLi" style="display: none;" ><label style="padding-left:16px;">填空内容：</label>
					...
					<li class="quOptionFillRequiredLi" style="display: none;"><label style="padding-left:15px;"><input type="checkbox" name="quOption_isRequiredFill" checked="checked" >&nbsp;该空可不填</label>&nbsp;</li>
		...
		<div class="dwSurveyAttrSetDialog dwQuFormSetDialog dwQuDialogCon" >
			<div class="tabbarDialog_1" >
					...
					<div class="p_DialogContent" >
						<div class="p_DialogContentTitle">何时开始</div>
						<div class="p_DialogContentRoot">
							<div class="p_DialogContentItem"><label><input type="checkbox" name="ynStartTime" value="1"> 到&nbsp;<input type="text" size="20"  class="inputSytle_1 Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="startTime" id="startTime" value="<fmt:formatDate value='${survey.surveyDetail.startTime}' pattern='yyyy-MM-dd HH:mm:ss'/>">&nbsp;时开始 </label></div>
						</div>
						...
						<div class="p_DialogContentRoot">
								...
								<div class="p_DialogContentItem"><label><input type="checkbox" name="ynEndTime" value="1"> 到&nbsp;<input type="text" size="20"  class="inputSytle_1 Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="endTime" id="endTime"  value="<fmt:formatDate value='${survey.surveyDetail.endTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" >&nbsp;时结束 </label></div>
						</div>
					</div>
					<div style="clear: both;"></div>
		...
		<div class="dwQuAutoAddZhenOption dwQuFormSetDialog dwQuDialogCon" style="padding-left: 0px;">
			<ul>
				<li><label style="padding-left:16px;">填空内容数据类型：</label>
					<select class="option_range" name="quColOption_checkType"  style="width:160px;padding: 5px;">
						<option value="NO">无验证</option>
						<option value="EMAIL">Email</option>
						<option value="NUM">数字</option>
						<option value="DIGITS">整数</option>
				...
				<li><label style="padding-left:15px;">此列：<input type="checkbox" name="quColOption_isRequiredFill" checked="checked" value="1" >&nbsp;必填</label>&nbsp;</li>
				<!-- <li>最多选&nbsp;<input type="text" size="3">&nbsp;项 </li> -->
			</ul>
			<div class="dwQuDialogBtnCon" ><input type="button" value="保存" class="quDialogBtn" id="dwDialogQuAutoAddZhenColSetSave"/></div>
		</div>
...
<script type="text/javascript">
	...
	$("input[name='ynStartTime'][value='${survey.surveyDetail.ynStartTime}']").attr("checked",true);
//	alert("${survey.surveyDetail.endTime}");
