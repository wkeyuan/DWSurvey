...
<body>
			...
			<div class="m-content-right" style="width:100%;">
					<div class="m-content-right-body">
						<div class="rightbody-tools">
								<a href="${ctx }/sy/system/nosm/sys-backup!input.action" class="btn001 click_a" title="新建文件夹">+&nbsp;新数据备份</a>&nbsp;&nbsp;
						</div>
						...
						<div class="content-list">
							...
							<table id="content-tableList" width="100%"  cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td align="left">${en.backupName }</td>
									<td align="left"><span class="hoverShow"><a href="">下载</a></span></td>
	...
	<div id="newDialog">
		<iframe id="newDialogFrame" width="620" height="200"  frameborder="0" ></iframe>
	</div>
</body>
</html>