...
<head>
    ...
    <style type="text/css">
        ...
        .quItem-ul li,.r-qu-body-ul1 li,input,.qusTable tr td{
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${en.quType eq 'FILLBLANK' }">
                                            <ul class="r-qu-body-ul1 r-qu-body-ul3">
                                                <li><div style="border: 1px solid #efefef;padding: 8px;font-size: 18px!important;">${en.anFillblank.answer }</div>
                                                        <%-- <input type="text"  name="qu_${en.quType }_${en.id }" value="${en.anFillblank.answer }"/> --%></li>
                                            </ul>
                                        </c:when>
                                        <%--多行填空 --%>
